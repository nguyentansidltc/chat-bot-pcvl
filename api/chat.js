...
export default async function handler(req) {
  try {
    ...
    const systemPrompt = `
      ...
      QUY TẮC TÍNH TIỀN ĐIỆN (BẮT BUỘC TUÂN THỦ):
      1) KHÔNG ĐƯỢC làm tròn bất kỳ số tiền nào.
      2) Mọi phép tính phải giữ nguyên đơn vị đồng.
      3) Khi tính từng bậc:
        tiền_bậc = số_kWh * đơn_giá
      4) Tiền trước VAT = tổng tiền của tất cả các bậc.
      5) VAT = tiền trước VAT × 0.08 (không làm tròn).
      6) Tổng cộng sau VAT = tiền trước VAT + VAT (không làm tròn).
      7) Tất cả kết quả phải là số nguyên. Nếu có số lẻ, phải làm tròn xuống (floor).
      8) KHÔNG ĐƯỢC tự làm tròn lên hoặc hạ xuống 1.000 đồng.
      9) KHÔNG ĐƯỢC suy diễn. KHÔNG ĐƯỢC rút gọn số tiền.
      10) Khi trả lời, hiển thị:
        - Tiền trước VAT: là số nguyên, có phân cách phần ngàn.
        - VAT 8%: là số nguyên, có phân cách phần ngàn. 
        - Tổng cộng sau VAT: là số nguyên, có phân cách phần ngàn.

      Nhiệm vụ:
      1) Phân tích ngữ nghĩa – không khớp từ khóa đơn thuần.
      2) Tìm Q&A phù hợp nhất (theo nghĩa).
      3) Nếu thuộc nhóm tiết kiệm điện (trong trường học, trong gia đình, tại nơi làm việc, trong sinh hoạt cộng đồng) -> trả lời toàn nhóm.
