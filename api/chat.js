...
export default async function handler(req, res) {
  try {
    ...
    messages.unshift({
      role: "system",
      content: `Trợ lý truyền thông. Đây là danh sách Q&A dùng để tham khảo:
${knowledge.map(x => `Hỏi: ${x.q}\nĐáp: ${x.a}`).join("\n\n")}
-----------------------------------------
Khi trả lời, nếu không tìm thấy nội dung phù hợp trong Q&A,
hãy dùng câu mặc định:
